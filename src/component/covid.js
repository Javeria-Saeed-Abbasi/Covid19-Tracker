...
import headache  from "../images/Stress.gif";
import fever  from "../images/fever.gif";
import cough  from "../images/virus-transmission1.gif";
import  sneezing from "../images/sneezing.gif";
...
const Covid = () => {
  ...
  const getCovidData = async () => {
    try {
      const response = await fetch(
        "https://api.covid19api.com/live/country/pakistan"
      );
  ...
  return (
    <div className="wrapper">
      <header>
        <nav
          className="navbar navbar-expand-md bg-nav fixed-top"
            ...
            <div className="content1">
              ...
              <div className="text2 position-absolute">
                <p className="Rubik">
                  ...
                  China on 17 November 2019, and on 11 March 2020, the World
                  Health Organization (WHO) declared the outbreak a panademic.
                </p>
              </div>
